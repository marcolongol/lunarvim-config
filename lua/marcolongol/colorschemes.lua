-- colorschemes configs (the configs table should have a setup() method)

local lunar_config = function()
  ...
  require("lunarvim").colorscheme()
end

local moonlight_config = function()
...
local colorschemes_dict = {
  { "lunarvim/lunar.nvim", config = lunar_config },
  { "shaunsingh/moonlight.nvim", config = moonlight_config },
  { "morhetz/gruvbox", {} },
